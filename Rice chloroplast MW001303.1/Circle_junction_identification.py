...
class RNASeqPipeline:
    def __init__(self, sample_prefix, genome_file1="MW001303.1.fasta", 
                 genome_file2="OS-chloroplas-intron-spliced-sequences-MW001303.1.fasta", output_dir="out", processed_log="processed_samples.log"):
...
def main():
    ...
    genome_file1 = "MW001303.1.fasta"
    genome_file2 = "OS-chloroplas-intron-spliced-sequences-MW001303.1.fasta"
    output_dir = "out"
