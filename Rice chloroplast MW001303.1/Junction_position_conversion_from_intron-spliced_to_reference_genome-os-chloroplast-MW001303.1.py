...
def process_position_correction():
    ...
    for input_file in glob.glob('*vlookup-result-sift*'):  
        ...
        conditions_4 = [
            df_process['3_C_num'] <= 2899,
            (df_process['3_C_num'] > 2899) & (df_process['3_C_num'] <= 4765),
            (df_process['3_C_num'] > 4765) & (df_process['3_C_num'] <= 6573)
        ]
        values_4 = [-70302, -91646, -90934]
        ...
        conditions_7 = [
            df_process['6_D_num'] <= 2899,
            (df_process['6_D_num'] > 2899) & (df_process['6_D_num'] <= 4765),
            (df_process['6_D_num'] > 4765) & (df_process['6_D_num'] <= 6573)
        ]
