...
class RNASeqPipeline:
    def __init__(self, sample_prefix, genome_file1="NC_007982.1.fa", 
                 genome_file2="Maize-mitochondrion-intron-sequence-NC_007982.1.fasta", output_dir="out", processed_log="processed_samples.log"):
...
def main():
    ...
    genome_file1 = "NC_007982.1.fa"
    genome_file2 = "Maize-mitochondrion-intron-sequence-NC_007982.1.fasta"
    output_dir = "out"
