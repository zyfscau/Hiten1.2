...
class RNASeqPipeline:
    def __init__(self, sample_prefix, genome_file1="KF241981.1.fasta", 
                 genome_file2="Maize-chloroplas-intron-spliced-sequences-KF241981.1.fasta", output_dir="out", processed_log="processed_samples.log"):
    ...
    def step10_rename_output_genome1(self):
        ...
        final_output = f"{self.sample_prefix}.chloroplas-{genome1_short}-100~3-ref_genome_junction_read_details"
    ...
    def step13_rename_output_genome2(self):
        ...
        final_output = f"{self.sample_prefix}.chloroplas-{genome2_short}-100~3-intron-spliced_junction_read_details"
...
def main():
    ...
    genome_file1 = "KF241981.1.fasta"
    genome_file2 = "Maize-chloroplas-intron-spliced-sequences-KF241981.1.fasta"
    output_dir = "out"
