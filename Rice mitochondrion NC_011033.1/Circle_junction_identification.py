...
class RNASeqPipeline:
    def __init__(self, sample_prefix, genome_file1="NC_011033.1.fasta", 
                 genome_file2="Rice-mitochondrion-chloroplas-tintron-spliced-sequences-NC_011033.1.fasta", output_dir="out", processed_log="processed_samples.log"):
...
def main():
    ...
    genome_file2 = "Rice-mitochondrion-chloroplas-tintron-spliced-sequences-NC_011033.1.fasta"
    output_dir = "out"
