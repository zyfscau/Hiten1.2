...
def main():
    ...
    recon_tasks = [
        ...
        "Junction_position_conversion_from_intron-spliced_to_reference_genome-os-mitochondrion-NC_011033.1.py",
    ...
    print("\n>>> Step 7: Execute tasks in Hiten_results directory")
    merge_tasks = [
        "Position_conversion_for_transcripts_derived_from_genome_junction-os-mitochondrion-NC_011033.1.py",
        "End_clustering.py",     
        "End_annotation.py"
    ]
